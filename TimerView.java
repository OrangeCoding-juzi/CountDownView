 ...
 *
 * @author morning
 * @version for 优化内存，灵魂编写
 * @date 2016/4/25-17:15
 * @desc ${倒计时}
 */
    ...
    class TimeItemView extends LinearLayout {
        ...
        private TextView getNumTv() {
            if (numTv == null) {
                ...
                numTv.setTextColor(context.getResources().getColor(R.color.text_color_o_yellow));
            }
            return numTv;
        }
        ...
        private TextView getUnitTv() {
            if (unitTv == null) {
                ...
                unitTv.setTextColor(context.getResources().getColor(R.color.text_color_6));
            }
            return unitTv;
        }
    }
